...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadData(int call) {
        ...
        if (data.getCount() == 0) {
            Toast.makeText(MainActivity.this, "Sin contenido que mostrar", Toast.LENGTH_SHORT).show();
        } else {
            String msg = "Ayuda, estoy en Latitud : " + x + " Longitud : " + y;
            String number = "";
            ...
            mFusedLocationClient.getLastLocation()
                    .addOnSuccessListener(new OnSuccessListener<Location>() {
                        ...
                        public void onSuccess(Location locationGPS) {
                            ...
                            if (locationGPS != null) {
                                ...
                                Toast.makeText(MainActivity.this, "Imposible encontrar ubicacion", Toast.LENGTH_SHORT).show();
                            }
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Log.d("Actividad: ", "Error al localizar con GPS");
                            e.printStackTrace();
                        }
                    });
        }
    ...
    private void onGPS() {
        ...
        builder.setMessage("Habilitar ?").setCancelable(false).setPositiveButton("Si", new DialogInterface.OnClickListener() {
            @Override
